  ...
  return (
    <div className="flex flex-row justify-center items-center px-4">
      ...
      <div
        ...
        className={
          (showDropdown ? ' ' : 'hidden ') +
          (user.isAdmin ? 'mt-64 ' : 'mt-56 ') +
          'absolute mr-10 z-10  bg-white divide-y rounded-lg shadow w-44'
        }
      >
        <ul className="py-2 text-sm text-primary">
          ...
          {user.isAdmin && (
            <li>
              <Link
                to={'/user/admin'}
                className="block px-4 py-2 hover:bg-primary hover:text-white w-full text-start"
              >
                Administrar
              </Link>
            </li>
