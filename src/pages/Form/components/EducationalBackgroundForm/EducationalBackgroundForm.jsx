        ...
        <div className="bg-[#FFFFFF] rounded-2xl w-screen md:mx-20 mt-5 pt-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4 mx-8 md:mx-20">
                ...
                <div className="form-group md:col-span-2 required position-relative">
                    ...
                    <select 
                        required
                        className={`form-control position-absolute w-80 md:w-5/6 h-10 px-4 pt-2 rounded-md border-2 border-custom-color mt-5 ${errors.lvlschool ? 'is-invalid' : ''}`} 
                        {...register('lvlschool')}>
                ...
                <div className="form-group md:col-span-2 required position-relative">
                    ...
                    <div className="form-group md:col-span-2 required mt-10 position-relative">
                        ...
                        type="text"
                        required
                        className={`form-control w-80 md:w-5/6 h-10 px-4 rounded-md border-2 border-custom-color mt-5 mb-2 ${errors.career1 ? 'is-invalid' : ''}`} 
                        {...register('career1')} 
                        />
                    ...
                    <div className="form-group required position-relative">
                        <label className="control-label position-absolute mb-10 mt-5 text-custom-color">Nombre institución 1:</label>
                        <div>
                            <Select 
                                name="institution1"
                                options={institutions}
                                className={`form-control basic-multi-select w-5/6 h-10 rounded-md mt-5 text-custom-color ${errors.institution1 ? 'is-invalid' : ''}`} 
                    ...
                    <div className="form-group required position-relative">
                        <label className="control-label position-absolute mb-10 mt-5 text-custom-color">Tipo institución 1:</label>
                        <div>
                            <Select 
                                name="typeschool1"
                                options={institutionsType}
                                className={`form-control basic-multi-select w-5/6 h-10 rounded-md mt-5 text-custom-color ${errors.typeschool1 ? 'is-invalid' : ''}`} 
                    ...
                    <div className="form-group md:col-span-2 required mt-10 position-relative">
                        ...
                        type="text"
                        required
                        className={`form-control w-80 md:w-5/6 h-10 px-4 rounded-md border-2 border-custom-color mt-5 mb-2 ${errors.career2 ? 'is-invalid' : ''}`} 
                        {...register('career2')} 
                        />
                    ...
                    {/* div institucion 1 */}
                    <div className="form-group required position-relative">
                        <label className="control-label position-absolute mb-10 mt-5 text-custom-color">Nombre institución 2:</label>
                        <div>
                            <Select 
                                name="institution2"
                                options={institutions}
                                className={`form-control basic-multi-select w-5/6 h-10 rounded-md mt-5 text-custom-color ${errors.institution2 ? 'is-invalid' : ''}`} 
                    ...
                    {/* div tipo institución 1 */}
                    <div className="form-group required position-relative">
                        <label className="control-label position-absolute mb-10 mt-5 text-custom-color">Tipo institución 2:</label>
                        <div>
                            <Select 
                                name="typeschool2"
                                options={institutionsType}
                                className={`form-control basic-multi-select w-5/6 h-10 rounded-md mt-5 text-custom-color ${errors.typeschool2 ? 'is-invalid' : ''}`} 
                ...
                <div className="form-group required mt-5 position-relative">
                    ...
                    <select 
                        required
                        className={`form-control position-absolute w-5/6 md:w-4/6 h-10 px-4 pt-2 rounded-md border-2 border-custom-color mt-5 ${errors.studies ? 'is-invalid' : ''}`} 
                        {...register('studies')}>
                ...
                <div className="form-group required mt-5 position-relative">
                    ...
                    <select 
                        required
                        className={`form-control position-absolute w-5/6 md:w-4/6 h-10 px-4 pt-2 rounded-md border-2 border-custom-color mt-5 ${errors.english ? 'is-invalid' : ''}`} 
                        {...register('english')}>
