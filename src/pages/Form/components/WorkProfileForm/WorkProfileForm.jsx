...
const WorkExperienceForm = () => {
    ...
    const { languages, frameworks, tools, getLanguages, getFrameworks, getTools } = useFetchSkills();
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-3 gap-4 mx-8 md:mx-20">
                    ...
                    <div className="form-group md:col-span-3 required position-relative mt-10">
                        ...
                        <textarea
                            ...
                            rows="5"
                            required
                            className={`form-control w-80 md:w-5/6 px-4 rounded-md border-2 border-custom-color mt-5 mb-2 bg-custom-color h-40 ${errors.others ? 'is-invalid' : ''}`}
                            {...register('others')}
                        />
