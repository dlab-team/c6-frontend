...
import { languageOptions, frameworkOptions, toolOptions, skillOptions } from '../docs/data.ts';
    ...
    return(
        ...
        <div className="bg-[#FFFFFF] rounded-2xl w-screen md:mx-20 mt-5 pt-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4 mx-8 md:mx-20">
                ...
                <p  className="mt-1 mb-5 text-left w-80 md:w-5/6 font-[400] text-[14px] leading-7 text-custom-color mt-5">Subir como documento público en Google Drive o similar</p>
                <input
                    name="resume"
                    type="text"
                    required
                ...
                <p  className="mt-1 mb-5 text-left w-80 md:w-5/6 font-[400] text-[14px] leading-7 text-custom-color mt-5"><br /> </p>
                <input
                    name="linkedin"
                    type="text"
                    required
                ...
                <label className="control-label md:grid-cols-3 position-absolute mt-10 mb-10 text-left w-80 md:w-5/6 font-[400] text-[18px] leading-9 text-custom-color mt-5">Explícanos en detalle algún proyecto que te enorgullece</label>
                <p  className="mt-1 mb-5 text-left w-80 md:w-5/6 font-[400] text-[14px] leading-7 text-custom-color mt-5">
                ...
                <textarea
                    name="proyecto"
                    rows="5"
                    className={`form-control w-80 md:w-5/6 h-10 px-4 rounded-md border-2 border-custom-color mt-5 mb-2 bg-custom-color h-40 ${errors.proyecto ? 'is-invalid' : ''}`} 
                    {...register('proyecto')} 
                />
                ...
                <div className={`${errors.years ? 'is-invalid' : ''}`}>
                    <div class="flex items-center mb-4 mt-4">
                        <input id="default-radio-1" type="radio" value="noxp" name="default-radio" class="w-4 h-4 radio-custom-color border-blue-200 bg-blue-200 checked:bg-blue-800 checked:border-blue-800" ref={register('occupation')}/>
                        <label for="default-radio-1" class="ml-2 text-sm font-medium select-custom-color font-[300] text-[14px]">No poseo experiencia laboral</label>
                    </div>
                    <div class="flex items-center mb-4 mt-4">
                        <input id="default-radio-1" type="radio" value="1xp" name="default-radio" class="w-4 h-4 radio-custom-color border-blue-200 bg-blue-200 checked:bg-blue-800 checked:border-blue-800" ref={register('occupation')}/>
                        <label for="default-radio-1" class="ml-2 text-sm font-medium select-custom-color font-[300] text-[14px]">Entre 0 a 1 año de experiencia laboral</label>
                    </div>
                    <div class="flex items-center mb-4 mt-4">
                        <input id="default-radio-1" type="radio" value="2xp" name="default-radio" class="w-4 h-4 radio-custom-color border-blue-200 bg-blue-200 checked:bg-blue-800 checked:border-blue-800" ref={register('occupation')}/>
                        <label for="default-radio-1" class="ml-2 text-sm font-medium select-custom-color font-[300] text-[14px]">Entre 1 a 2 años de experiencia laboral</label>
                    </div>
                    <div class="flex items-center mb-4 mt-4">
                        <input id="default-radio-1" type="radio" value="3xp" name="default-radio" class="w-4 h-4 radio-custom-color border-blue-200 bg-blue-200 checked:bg-blue-800 checked:border-blue-800" ref={register('occupation')}/>
                        <label for="default-radio-1" class="ml-2 text-sm font-medium select-custom-color font-[300] text-[14px]">Entre 2 a 3 años de experiencia laboral</label>
                    </div>
                    <div class="flex items-center mb-4 mt-4">
                        <input id="default-radio-1" type="radio" value="4xp" name="default-radio" class="w-4 h-4 radio-custom-color border-blue-200 bg-blue-200 checked:bg-blue-800 checked:border-blue-800" ref={register('occupation')}/>
                        <label for="default-radio-1" class="ml-2 text-sm font-medium select-custom-color font-[300] text-[14px]">Más de 4 años de experiencia laboral</label>
                    </div>
                </div>
