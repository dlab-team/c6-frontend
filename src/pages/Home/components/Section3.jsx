        ...
        <div className="container">
          <div className="flex flex-col lg:flex-row w-full mb-24 mt-40 font-[Poppins]">
            <div className="">
              ...
              <img src={Zen} className="hidden lg:block mx-auto my-10 w-[443px] h-[372px]" alt="" />
            ...
            <div className="bg-[#140B34] h-[1040px] w-[360px] md:w-[590px] rounded-2xl mx-auto md:mx-24 -mt-4">
              ...
              <div className="flex flex-col md:flex-row md:justify-between mx-10 md:mx-14 mt-10 font-[400]">
                <div>
                  <label for="first_name" className="mb-4 text-[16px] text-[#FFFFFF]">Nombre *</label>
                  <input type="text" id="nombre" className=" bg-[#E2F2FE] mb-3 mt-3 w-[18rem] md:w-[14rem] text-gray-900 text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                <div>
                  <label for="last_name" className="md:ml-4 mb-4 text-[16px] text-[#FFFFFF]">Apellido *</label>
                  <input type="text" id="apellido" className="md:ml-4 bg-[#E2F2FE] mb-3 mt-3 w-[18rem] md:w-[14rem] text-gray-900 text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
              </div>
              <div className="flex flex-col md:flex-row md:justify-between mt-2 mx-10 md:mx-14">
                ...
                <div>
                  ...
                  <input type="text" id="telefono" className="md:ml-4 bg-[#E2F2FE] mb-3 mt-3 w-[18rem] md:w-[14rem] text-gray-900 text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
              </div>
              <div>
                <label className="mt-2 mb-4 mx-10 md:mx-14 text-[16px] font-medium text-[#FFFFFF]">¿A que empresa perteneces? *</label>
                <input type="tel" id="empresa" className="mx-10 md:mx-14 bg-[#E2F2FE] mb-3 mt-3 w-[18rem] md:w-[30rem] text-gray-900 text-[14px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
              </div>
              ...
              <div className="mx-10 md:mx-14 mt-10 hidden md:block">
                ...
                <textarea rows="5" className="mt-3 p-2.5 w-full text-sm text-gray-900 bg-[#E2F2FE] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder=""></textarea>
              </div>

              {/* boton enviar formulario */}
              <div className="flex items-start mx-20 ml-12 mt-10 mb-6">
                <button className="h-[60px] w-[137px] bg-[#575253] hover:bg-gray-200 text-[#232323] text-[24px] font-bold py-2 px-4 rounded-3xl cursor-not-allowed opacity-50">ENVIAR</button>
              </div>
