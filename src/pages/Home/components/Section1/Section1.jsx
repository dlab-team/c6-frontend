...
const Section01 = () => {
  return (
    <>
      <div className="bg-hero-gradient2 flex font-thin justify-center bg-hero bg-no-repeat bg-cover text-white">
        <div className="flex-col text-center md:text-left mx-14 md:mx-0">
          ...
          <div className="content flex text-center md:text-left mx-14 md:mx-0">
            <div className="hero mt-4 mb-[15rem] flex flex-col  items-start md:ml-24">
              ...
              <Link
                to="/form-looking"
                className="mt-20 md:mt-32 bg-white text-[#2738f5] py-[1.3rem] px-8 text-center rounded-3xl text-2xl font-bold  hover:opacity-80"
                href=""
              >
                BUSCO TRABAJO
              </Link>
