...
const Section2 = () => {
  return (
    <>
      <section id="como-funcionamos" className="py-20">
        <div className="md:flex container mx-auto">
          <div className="m-auto">
            <h3 className="text-black font-bold text-3xl mb-10 text-center mt-10 md:mt-0">
              ¿Cómo funcionamos?
            </h3>
            <p className="text-black text-2xl text-center">
              Da click a nuestro video y en sólo 60 segundos conoce{' '}
              <span className="text-primary font-bold">Devsafio</span> y cómo
              estamos{' '}
      ...
      <section
        className="bg-secondary pt-40 pb-20"
        id="sin-juniors-no-hay-seniors"
      >
        <div className="flex flex-col container mx-auto">
          <h3 className="text-black font-bold text-3xl mb-10 text-center">
        ...
        <div className="flex flex-col md:flex-row container mx-auto mt-16 pb-16 md:justify-around items-center">
          <div className="flex flex-col gap-10 text-center items-center max-w-xs px-6">
            ...
            <p className="text-black text-xl">
              ...
              un listado con los mejores candidatos en{' '}
          ...
          <div className="flex flex-col gap-10 text-center items-center max-w-xs px-6">
            ...
            <p className="text-black text-xl">
              ...
              que contrates{' '}
              <span className="font-bold">
                serán guiados y apoyados a nivel técnico
              </span>{' '}
              por un mentor senior TI experto en tu área{' '}
              <span className="font-bold">sin ningún costo ($0)</span>.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-10 text-center items-center max-w-xs px-6">
            ...
            <p className="text-black text-xl">
              ...
              <span className="font-bold">seguimiento</span> de alta calidad
              para{' '}
              <span className="font-bold">
                potenciar el crecimiento y desarrollo técnico
              </span>{' '}
